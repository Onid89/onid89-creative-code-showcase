...
const translations: Translations = {
  ...
  'about.career.p1': {
    en: 'After an international career in the world of dance, with experience at renowned theaters such as Deutsche Oper Berlin, Theater Chemnitz, and Semperoper Dresden, I decided to take on a new professional challenge in web development. Driven by curiosity, a passion for technology, and the desire to build practical digital solutions, I completed the Full Stack Web Development program at DCI Career Institute in Berlin in February 2025.',
    de: 'Nach einer internationalen Karriere in der Welt des Tanzes, mit Erfahrungen an renommierten Theatern wie der Deutschen Oper Berlin, dem Theater Chemnitz und der Semperoper Dresden, habe ich mich entschieden, eine neue berufliche Herausforderung im Bereich Webentwicklung anzunehmen. Angetrieben von Neugier, einer Leidenschaft für Technologie und dem Wunsch, praktische digitale Lösungen zu entwickeln, habe ich im Februar 2025 das Full Stack Web Development Programm am DCI Career Institute in Berlin abgeschlossen.',
    it: 'Dopo una carriera internazionale nel mondo della danza, con esperienze in teatri rinomati come Deutsche Oper Berlin, Theater Chemnitz e Semperoper Dresden, ho deciso di intraprendere una nuova sfida professionale nel campo dello sviluppo web. Spinto dalla curiosità, dalla passione per la tecnologia e dal desiderio di creare soluzioni digitali concrete, ho completato il programma di Full Stack Web Development presso il DCI Career Institute di Berlino nel febbraio 2025.'
  },
  'about.career.p2': {
    en: 'Throughout my training, I gained hands-on experience with HTML, CSS, JavaScript, React, Node.js, Express, and MongoDB, working on real-world projects that strengthened both my technical and communication skills. After completing the course, I also took part in an AI focused course at DCI in May 2026, where I explored how artificial intelligence can support modern web development, improve productivity, and assist in building more efficient digital solutions. Following my studies, I completed a two-month internship at Drengr Tech IT Solution, where I applied my knowledge in a professional setting and contributed to the frontend development of web applications.',
    de: 'Während meiner Ausbildung sammelte ich praktische Erfahrung mit HTML, CSS, JavaScript, React, Node.js, Express und MongoDB und arbeitete an realitätsnahen Projekten, die sowohl meine technischen Fähigkeiten als auch meine Kommunikationsfähigkeiten gestärkt haben. Nach Abschluss des Kurses nahm ich im Mai 2026 außerdem an einem AI fokussierten Kurs bei DCI teil, in dem ich lernte, wie künstliche Intelligenz die moderne Webentwicklung unterstützen, die Produktivität verbessern und bei der Entwicklung effizienterer digitaler Lösungen helfen kann. Im Anschluss absolvierte ich ein zweimonatiges Praktikum bei Drengr Tech IT Solution, wo ich mein Wissen in einem professionellen Umfeld anwenden und zur Frontend-Entwicklung von Webanwendungen beitragen konnte.',
    it: 'Durante il mio percorso di formazione, ho acquisito esperienza pratica con HTML, CSS, JavaScript, React, Node.js, Express e MongoDB, lavorando su progetti reali che hanno rafforzato sia le mie competenze tecniche sia le mie capacità comunicative. Dopo il completamento del corso, ho anche preso parte a un corso dedicato all’intelligenza artificiale presso DCI nel maggio 2026, dove ho approfondito come l’AI possa supportare lo sviluppo web moderno, migliorare la produttività e aiutare nella creazione di soluzioni digitali più efficienti. Successivamente, ho completato un tirocinio di due mesi presso Drengr Tech IT Solution, dove ho applicato le mie conoscenze in un contesto professionale e contribuito allo sviluppo frontend di applicazioni web.'
  },
  'about.career.p3': {
    en: 'My background in the performing arts taught me discipline, teamwork, adaptability, and attention to detail, qualities I now bring to my new path in tech. I am currently seeking my first professional opportunity as a Junior Web Developer, where I can continue to grow, learn, and contribute to innovative digital projects in a dynamic and supportive environment. My current focus is on frontend development, AI assisted workflows, and automation. I am also exploring no code and low code tools such as n8n to build practical workflows that connect services, organize data, automate repetitive tasks, and improve everyday productivity.',
    de: 'Mein Hintergrund in den darstellenden Künsten hat mir Disziplin, Teamarbeit, Anpassungsfähigkeit und Liebe zum Detail vermittelt, Eigenschaften, die ich heute in meinen neuen Weg in der Tech-Branche einbringe. Derzeit suche ich meine erste berufliche Möglichkeit als Junior Web Developer, bei der ich weiter wachsen, lernen und zu innovativen digitalen Projekten in einem dynamischen und unterstützenden Umfeld beitragen kann. Mein aktueller Fokus liegt auf Frontend-Entwicklung, AI unterstützten Workflows und Automatisierung. Außerdem beschäftige ich mich mit No Code und Low Code Tools wie n8n, um praktische Workflows zu erstellen, die Dienste verbinden, Daten organisieren, wiederholende Aufgaben automatisieren und die tägliche Produktivität verbessern.',
    it: 'Il mio background nelle arti performative mi ha insegnato disciplina, lavoro di squadra, adattabilità e attenzione ai dettagli, qualità che oggi porto con me nel mio nuovo percorso nel mondo tech. Attualmente sono alla ricerca della mia prima opportunità professionale come Junior Web Developer, dove poter continuare a crescere, imparare e contribuire a progetti digitali innovativi in un ambiente dinamico e collaborativo. Il mio focus attuale è sullo sviluppo frontend, sui workflow assistiti dall’intelligenza artificiale e sull’automazione. Sto inoltre esplorando strumenti no code e low code come n8n per creare workflow pratici che collegano servizi, organizzano dati, automatizzano attività ripetitive e migliorano la produttività quotidiana.'
    },
